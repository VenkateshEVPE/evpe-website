      ...
      <div className={`${containerClass ? containerClass : "container"}`}>
        <div className="row">
          ...
          >
            {/* footer copyright */}
            <FooterCopyright
              footerLogo="/assets/img/logo/evpe-logo1.webp"
            ...
            <div className="footer-widget mb-30 ml-30">
              ...
              <div className="footer-list">
                <ul>
                  ...
                  <li>
                    <Link to={process.env.PUBLIC_URL + "/leasing"}>
                     Leasing
                    </Link>
                  </li>
                  <li>
            ...
            >
              ...
              <div className="footer-list">
                <ul>                 
                  ...
                  <li>
                    <Link to={process.env.PUBLIC_URL + "/used"}>Used</Link>
                  </li>
                  <li>
                    <Link to={process.env.PUBLIC_URL + "/blog-standard"}>Blogs</Link>
                  </li>
                  <li>
